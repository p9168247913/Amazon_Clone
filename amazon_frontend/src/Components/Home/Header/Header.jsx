    ...
    <div className="slider">
      <div className="slides">
        ...
        <div className="slide first">
          <img src="https://m.media-amazon.com/images/I/71LbHsact9L._SX3000_.jpg" alt="sp"/>
        </div>
        <div className="slide">
          <img src="https://m.media-amazon.com/images/I/61gPOiG6YiL._SX3000_.jpg" alt="sp"/>
        </div>
        <div className="slide">
          <img src="https://m.media-amazon.com/images/I/61aURrton0L._SX3000_.jpg" alt="sp"/>
        </div>
        <div className="slide">
          <img src="https://m.media-amazon.com/images/I/81aKds7BOeL._SX3000_.jpg" alt="sp"/>
        </div>
