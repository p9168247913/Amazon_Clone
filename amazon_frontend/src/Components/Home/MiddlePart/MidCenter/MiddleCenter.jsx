            ...
            <div className={style.childOne}>
                ...
                <div className={style.childTwo}>
                    ...
                    <div className={style.childThree}>
                        ...
                        <Link to={"/appliances"} className={style.chidFour}>
                            ...
                            <p style={{ fontWeight: "lighter" }}>Up to 450% off | appliances</p>
                        </Link>
                        <div className={style.chidFour}>
                ...
                <div className={style.childTwo}>
                    ...
                    <div className={style.childThree}>
                        <Link to={"/watch"} className={style.chidFour}>
                            ...
                            <p style={{ fontWeight: "lighter" }}>Smartwatches</p>
                        </Link>
                        <div className={style.chidFour}>
                        ...
                        <Link to={"/laptop"} className={style.chidFour}>
                            ...
                            <p style={{ fontWeight: "lighter" }}>Laptops</p>
                        </Link>
                        <div className={style.chidFour}>
